...
class HDF5Writer:
    ...
    def new_file(self, filepath: str | Path, meta: ExperimentMeta):
        ...
        self.logger.info(f"Created new file: {self._filepath}")
    ...
    def import_file(self, filepath: str | Path) -> ExperimentMeta:
        ...
        self._meta = meta
        self.logger.info(f"Imported file: {self._filepath}")
        return meta
    ...
    def _write_metea(self, grp: h5py.Group, meta: ExperimentMeta):
        ...
        grp.attrs["date_creates"] = meta.date_created
    ...
    def _write_discharge_meta(self, grp: h5py.Group, meta: DischargeMeta):
        ...
        grp.attrs["voltage_cr"] = meta.voltage_cr
        grp.attrs["current_cr"] = meta.current_cr
        grp.attrs["pressure_cr_mks"] = meta.pressure_cr_mks
        grp.attrs["pressure_cr_kjl"] = meta.pressure_cr_kjl
